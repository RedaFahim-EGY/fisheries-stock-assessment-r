...
- length
- observed age
- year/season/area/source
- reader identifier where available
- repeat/paired readings where available

Age–length keys should be evaluated for support and transferability before they are applied to periods, areas or fleets outside the data from which they were estimated.
